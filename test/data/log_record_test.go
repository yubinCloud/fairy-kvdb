...
func TestEncodeLogRecord(t *testing.T) {
	...
	assert.Equal(t, []byte("name"), encBytes1[7:11])
	assert.Equal(t, []byte("zhangSan"), encBytes1[11:19])
	assert.Equal(t, int64(19), totalSize1) // 19 = 4 + 1 + 1 + 1 + 4 + 8
	...
	assert.Equal(t, []byte("name"), encBytes2[7:11])
	assert.Equal(t, int64(11), totalSize2)
	...
	assert.Equal(t, []byte("name"), encBytes3[7:11])
	assert.Equal(t, []byte("zhangSan"), encBytes3[11:19])
	assert.Equal(t, int64(19), totalSize3)
}
...
func TestDecodeLogRecordHeader(t *testing.T) {
	...
	assert.Equal(t, uint32(1289606445), decodedHeader1.Crc)
	...
	assert.Equal(t, uint32(240712713), decodedHeader2.Crc)
	...
	assert.Equal(t, uint32(4112912069), decodedHeader3.Crc)
...
func TestComputeCRC(t *testing.T) {
	...
	assert.Equal(t, uint32(1289606445), crc)
}
